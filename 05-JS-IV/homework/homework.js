...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
  ...
  // Tu código:
  var producto = objetoMisterioso.numeroMisterioso;
  return producto * 5;
}
...
function tienePropiedad(objeto, propiedad) {
  ...
  // Tu código:
  var prueba = propiedad;
  var aprobada = objeto[prueba];
...
function actualizarPassword(usuario, nuevaPassword) {
  ...
  // Devuelve el objeto
  // Tu código:
  var nuevaContraseña = nuevaPassword;
...
function sumarLikesDeUsuario(usuario) {
  ...
  for ( var i = 0; i < posteos.length; i++) {
    meGustas = meGustas + posteos[i]['likes']; 
  }
  return meGustas;
}
